...
input_csv = ['ACCURACY[loo]_RAWpt_SVM.csv', 'ACCURACY[loo]_RAWts_1dCNN.csv', 'ACCURACY[loo]_TDAvecAutocor01dim300_1dCNN.csv']

# input_csv = ['ACCURACY[loo]_RAWpt_SVM.csv', 'ACCURACY[loo]_RAWts_SVM.csv', 'ACCURACY[loo]_RAWvecSPMts_SVM.csv']
