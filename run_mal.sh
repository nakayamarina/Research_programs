...
do
  ...
  do
    ...
    # python 1dCNN_TDAvec_autocor_raw.py ${PATH_RAW}
    python 1dCNN_TDAvec_autocor_Raw_pt.py ${PATH_RAW}
    ...
    # python 1dCNN_TDAvec_autocor_raw.py ${PATH_MAL}

    python 1dCNN_TDAvec_autocor_Raw_pt.py ${PATH_MAL}
    ...
    PATH_MAL="${PATH_DATA}${dir}${image_method}/MAL7/"
