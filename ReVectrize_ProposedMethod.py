...
# ベクトル化し直すデータ
ReVec_restData = 'TDAvec_autocor_rest_custom_300_012dim.csv'
ReVec_tapData = 'TDAvec_autocor_tap_custom_300_012dim.csv'
...
if __name__ == '__main__':
    ...
    newRestVec, paraName = ReVec(ReVec_restData)
    newTapVec, paraName = ReVec(ReVec_tapData)
