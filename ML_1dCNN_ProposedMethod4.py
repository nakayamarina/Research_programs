...
ML_restData = 'TDAvec_autocor_rest_custom_300_01dim.csv'
ML_tapData = 'TDAvec_autocor_tap_custom_300_01dim.csv'

# 出力するデータの行名，ファイル名
outputIndex = 'TDAvec_autocor(300, 01dim) + 1dCNN'
outputFile = 'TDAvecAutocor01dim300'
