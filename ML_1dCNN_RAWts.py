...
# # 一次元CNNによる学習と識別性能評価（生データ+提案手法（時系列））
...
# ---
#
# 出力：ACCURACY[loo]_(ファイル名)_1dCNN.csv　識別性能評価
#
# ---
#
# 各ボクセルの時系列データをベクトルとして1dCNNを用いて学習，交差検証法（leave-one-out交差検証）を用いて識別性能評価を行う．
...
# コマンドライン引数で提案手法でraw_rest.csv/raw_tap.csvファイルがあるディレクトリまでのパスを取得
