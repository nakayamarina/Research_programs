...
ML_restData = 'TDAvec_autocor_rest_custom_100_01dim.csv'
ML_tapData = 'TDAvec_autocor_tap_custom_100_01dim.csv'

# 出力するデータの行名，ファイル名
outputIndex = 'TDAvec_autocor(100, 01dim) + 1dCNN'
outputFile = 'TDAvecAutocor01dim100'
